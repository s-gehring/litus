...
export const NUMERIC_SETTING_META: NumericSettingMeta[] = [
	...
	{
		key: "limits.artifactsPerFileMaxBytes",
		label: "Artifacts Per-File Size Cap",
		description: "Reject any single Artifacts-step file larger than this cap",
		min: 1_048_576,
	...
	{
		key: "limits.artifactsPerStepMaxBytes",
		label: "Artifacts Per-Step Size Cap",
		description: "Stop accepting Artifacts-step files once their total size exceeds this cap",
		min: 1_048_576,
	...
	{
		key: "timing.artifactsTimeoutMs",
		label: "Artifacts Timeout",
		description: "Wall-clock timeout for the Artifacts step before killing the run",
		min: 60_000,
		defaultValue: 1_800_000,
		unit: "ms",
		inputKind: "duration",
